...
var counter_minutes = document.getElementById('js_counter_minutes');
var counter_hours = document.getElementById('js_counter_hours');
var counter_days = document.getElementById('js_counter_days');
...
function flip(){
	function setClass(){
		counter_minutes.className += ' flip';
	}
	window.setTimeout(setClass, 20);
	counter_minutes.className = originalClass;
}
